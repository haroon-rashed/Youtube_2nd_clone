...
import BookCardGrid from './Component/BookCardGrid/BookCardGrid';
// import BookTable from './Component/BookCardGrid/BookTable';
import BookFormWrapper from './Component/BookCardGrid/BookForm/BookFormWrapper';
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/videos' element={<PrivateRoute i>
            <VideoCardGrid/>
          </PrivateRoute>} />
